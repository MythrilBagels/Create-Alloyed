...
public class PressingRecipes extends ModProcessingRecipes {
    ...
    public CreateRecipeProvider.GeneratedRecipe BRONZE_SHEET = create("bronze_sheet", b -> b
            .require(ModTags.Items.BRONZE_INGOT)
            .output(ModItems.BRONZE_SHEET.get())
    );

    public CreateRecipeProvider.GeneratedRecipe STEEL_SHEET = create("steel_sheet", b -> b
