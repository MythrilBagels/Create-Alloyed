package com.spottytheturtle.create_composition.fluids;
...
public class ModFluids {
    ...
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(ForgeRegistries.FLUIDS, create_composition.MOD_ID);
